...
static const yytype_uint16 yyrline[] =
{
     ...
     138,   140,   150,   158,   160,   161,   163,   165,   170,   165,
     176,   185,   186,   187,   189,   201,   201,   203,   204,   205,
     206,   207,   208,   209,   210,   211,   213,   228,   228,   236,
     236,   243,   251,   256,   251,   264,   275,   276,   283,   285,
     291,   299,   300,   302,   309,   314,   319,   325,   327,   338,
     338,   360,   372,   382,   386,   394,   400,   449,   498,   519,
     531,   545,   559,   572,   585,   593,   594,   595,   605,   607,
     608,   613,   620,   621,   629,   630,   631,   632
};
#endif
...
/* Line 1455 of yacc.c  */
#line 140 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 150 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 163 "sintactico_semantico.y"
...
/* Line 1455 of yacc.c  */
#line 170 "sintactico_semantico.y"
    {
		CuentaParametros();
		;}
    break;
...
/* Line 1455 of yacc.c  */
#line 172 "sintactico_semantico.y"
    {
		en_fun=en_fun+1;
...
/* Line 1455 of yacc.c  */
#line 176 "sintactico_semantico.y"
    {
	en_fun=en_fun+1;
...
/* Line 1455 of yacc.c  */
#line 185 "sintactico_semantico.y"
...
/* Line 1455 of yacc.c  */
#line 186 "sintactico_semantico.y"
...
/* Line 1455 of yacc.c  */
#line 213 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 234 "sintactico_semantico.y"
    {delete_descriptor();;}
    break;
...
/* Line 1455 of yacc.c  */
#line 236 "sintactico_semantico.y"
    {escribe_else();;}
    break;
...
/* Line 1455 of yacc.c  */
#line 243 "sintactico_semantico.y"
    {
		if(en_fun==0)
...
/* Line 1455 of yacc.c  */
#line 251 "sintactico_semantico.y"
    {
	DescriptorControl d;
...
/* Line 1455 of yacc.c  */
#line 256 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 262 "sintactico_semantico.y"
    {fin_while();;}
    break;
...
/* Line 1455 of yacc.c  */
#line 275 "sintactico_semantico.y"
...
/* Line 1455 of yacc.c  */
#line 285 "sintactico_semantico.y"
    {
	if(es_pila((yyvsp[(2) - (3)]).tipo)==1){
...
/* Line 1455 of yacc.c  */
#line 291 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 299 "sintactico_semantico.y"
...
/* Line 1455 of yacc.c  */
#line 302 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 309 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 314 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 319 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 338 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 343 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 360 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 372 "sintactico_semantico.y"
    {
		(yyval).nargumentos=1;
		(yyval).nombre=(yyvsp[(1) - (1)]).nombre;
		if((yyval).nargumentos<=numparam){
...
/* Line 1455 of yacc.c  */
#line 382 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 386 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 394 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 400 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 449 "sintactico_semantico.y"
    {
	//Valor y pila (solo el *)
...
/* Line 1455 of yacc.c  */
#line 498 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 519 "sintactico_semantico.y"
    {
		if(((yyvsp[(1) - (3)]).tipo)!=((yyvsp[(3) - (3)]).tipo)){
			printf("\nError Semantico en la linea %d: Tipos incompatibles: %s incompatible con %s.\n",yylineno,MostrarTipo((yyvsp[(1) - (3)]).tipo),MostrarTipo((yyvsp[(3) - (3)]).tipo));
				correcto=0;
...
/* Line 1455 of yacc.c  */
#line 545 "sintactico_semantico.y"
    {
		if(((yyvsp[(1) - (3)]).tipo)!=((yyvsp[(3) - (3)]).tipo)){
			printf("\nError Semantico en la linea %d: Tipos incompatibles: %s incompatible con %s.\n",yylineno,MostrarTipo((yyvsp[(1) - (3)]).tipo),MostrarTipo((yyvsp[(3) - (3)]).tipo));
				correcto=0;
...
/* Line 1455 of yacc.c  */
#line 559 "sintactico_semantico.y"
    {
		if(((yyvsp[(1) - (3)]).tipo)!=((yyvsp[(3) - (3)]).tipo)){
			printf("\nError Semantico en la linea %d: Tipos incompatibles: %s incompatible con %s.\n",yylineno,MostrarTipo((yyvsp[(1) - (3)]).tipo),MostrarTipo((yyvsp[(3) - (3)]).tipo));
				correcto=0;
...
/* Line 1455 of yacc.c  */
#line 572 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 585 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 593 "sintactico_semantico.y"
...
/* Line 1455 of yacc.c  */
#line 594 "sintactico_semantico.y"
...
/* Line 1455 of yacc.c  */
#line 595 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 613 "sintactico_semantico.y"
    {
		if(existe((yyvsp[(1) - (1)]).lexema)==0){
			printf("\nError Semantico en la linea %d: Identificador %s no declarado\n",yylineno,(yyvsp[(1) - (1)]).lexema);}
		else{
...
/* Line 1455 of yacc.c  */
#line 620 "sintactico_semantico.y"
    {(yyval).tipo=(yyvsp[(1) - (1)]).tipo; (yyval).nombre=(yyvsp[(1) - (1)]).nombre;;}
    break;
...
/* Line 1455 of yacc.c  */
#line 621 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 629 "sintactico_semantico.y"
...
/* Line 1455 of yacc.c  */
#line 630 "sintactico_semantico.y"
    {(yyval).tipo=(yyvsp[(1) - (1)]).tipo;(yyval).nombre=(yyvsp[(1) - (1)]).lexema;;}
    break;
...
/* Line 1455 of yacc.c  */
#line 631 "sintactico_semantico.y"
    {(yyval).tipo=(yyvsp[(1) - (1)]).tipo;(yyval).nombre=(yyvsp[(1) - (1)]).lexema;;}
    break;
...
/* Line 1455 of yacc.c  */
#line 632 "sintactico_semantico.y"
...
/* Line 1675 of yacc.c  */
#line 639 "sintactico_semantico.y"
