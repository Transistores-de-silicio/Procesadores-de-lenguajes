...
static const yytype_uint16 yyrline[] =
{
     ...
     175,   183,   184,   185,   187,   199,   199,   201,   202,   203,
     204,   205,   206,   207,   208,   209,   211,   226,   226,   234,
     234,   241,   248,   253,   248,   261,   272,   273,   280,   282,
     288,   296,   297,   299,   306,   311,   316,   322,   324,   335,
     335,   357,   369,   379,   383,   391,   397,   446,   495,   516,
     528,   542,   556,   569,   582,   590,   591,   592,   602,   604,
     605,   610,   617,   618,   626,   627,   628,   629
};
#endif
...
/* Line 1455 of yacc.c  */
#line 183 "sintactico_semantico.y"
...
/* Line 1455 of yacc.c  */
#line 184 "sintactico_semantico.y"
...
/* Line 1455 of yacc.c  */
#line 187 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 211 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 226 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 232 "sintactico_semantico.y"
    {delete_descriptor();;}
    break;
...
/* Line 1455 of yacc.c  */
#line 241 "sintactico_semantico.y"
    {
		if(en_fun==0)
...
/* Line 1455 of yacc.c  */
#line 248 "sintactico_semantico.y"
    {
	DescriptorControl d;
...
/* Line 1455 of yacc.c  */
#line 261 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 272 "sintactico_semantico.y"
...
/* Line 1455 of yacc.c  */
#line 273 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 282 "sintactico_semantico.y"
    {
	if(es_pila((yyvsp[(2) - (3)]).tipo)==1){
...
/* Line 1455 of yacc.c  */
#line 288 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 296 "sintactico_semantico.y"
...
/* Line 1455 of yacc.c  */
#line 335 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 357 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 369 "sintactico_semantico.y"
    {
		(yyval).nargumentos=1;
		(yyval).nombre=(yyvsp[(1) - (1)]).nombre;
		if((yyval).nargumentos<=numparam){
...
/* Line 1455 of yacc.c  */
#line 379 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 383 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 391 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 397 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 446 "sintactico_semantico.y"
    {
	//Valor y pila (solo el *)
...
/* Line 1455 of yacc.c  */
#line 495 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 516 "sintactico_semantico.y"
    {
		if(((yyvsp[(1) - (3)]).tipo)!=((yyvsp[(3) - (3)]).tipo)){
			printf("\nError Semantico en la linea %d: Tipos incompatibles: %s incompatible con %s.\n",yylineno,MostrarTipo((yyvsp[(1) - (3)]).tipo),MostrarTipo((yyvsp[(3) - (3)]).tipo));
				correcto=0;
...
/* Line 1455 of yacc.c  */
#line 528 "sintactico_semantico.y"
    {
		if(((yyvsp[(1) - (3)]).tipo)!=((yyvsp[(3) - (3)]).tipo)){
			printf("\nError Semantico en la linea %d: Tipos incompatibles: %s incompatible con %s.\n",yylineno,MostrarTipo((yyvsp[(1) - (3)]).tipo),MostrarTipo((yyvsp[(3) - (3)]).tipo));
				correcto=0;
...
/* Line 1455 of yacc.c  */
#line 542 "sintactico_semantico.y"
    {
		if(((yyvsp[(1) - (3)]).tipo)!=((yyvsp[(3) - (3)]).tipo)){
			printf("\nError Semantico en la linea %d: Tipos incompatibles: %s incompatible con %s.\n",yylineno,MostrarTipo((yyvsp[(1) - (3)]).tipo),MostrarTipo((yyvsp[(3) - (3)]).tipo));
				correcto=0;
...
/* Line 1455 of yacc.c  */
#line 556 "sintactico_semantico.y"
    {
		if(((yyvsp[(1) - (3)]).tipo)!=((yyvsp[(3) - (3)]).tipo)){
			printf("\nError Semantico en la linea %d: Tipos incompatibles: %s incompatible con %s.\n",yylineno,MostrarTipo((yyvsp[(1) - (3)]).tipo),MostrarTipo((yyvsp[(3) - (3)]).tipo));
				correcto=0;
...
/* Line 1455 of yacc.c  */
#line 569 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 582 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 590 "sintactico_semantico.y"
...
/* Line 1455 of yacc.c  */
#line 591 "sintactico_semantico.y"
...
/* Line 1455 of yacc.c  */
#line 592 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 605 "sintactico_semantico.y"
    {
		if(es_pila((yyvsp[(2) - (3)]).tipo)==1){
...
/* Line 1455 of yacc.c  */
#line 610 "sintactico_semantico.y"
    {
		if(existe((yyvsp[(1) - (1)]).lexema)==0){
			printf("\nError Semantico en la linea %d: Identificador %s no declarado\n",yylineno,(yyvsp[(1) - (1)]).lexema);}
		else{
...
/* Line 1455 of yacc.c  */
#line 617 "sintactico_semantico.y"
    {(yyval).tipo=(yyvsp[(1) - (1)]).tipo; (yyval).nombre=(yyvsp[(1) - (1)]).nombre;;}
    break;
...
/* Line 1455 of yacc.c  */
#line 618 "sintactico_semantico.y"
    {
...
/* Line 1455 of yacc.c  */
#line 626 "sintactico_semantico.y"
...
/* Line 1455 of yacc.c  */
#line 628 "sintactico_semantico.y"
    {(yyval).tipo=(yyvsp[(1) - (1)]).tipo;(yyval).nombre=(yyvsp[(1) - (1)]).lexema;;}
    break;
...
/* Line 1675 of yacc.c  */
#line 636 "sintactico_semantico.y"
